'use strict';
angular.module("WebCoreModule",["ngSanitize","ngTouch","pascalprecht.translate","ui.bootstrap","ui.mask","ui.router","ui.select","WcResponsiveTableModule"]).config(["$httpProvider",function(o){o.useApplyAsync(!0)}]),angular.module("WebCoreModule").constant("_",window._),angular.module("WebCoreModule").constant("XLSX",window.XLSX),angular.module("WebCoreModule").constant("saveAs",window.saveAs),angular.module("WebCoreModule").constant("pdfMake",window.pdfMake),angular.module("WebCoreModule").constant("Chart",window.Chart),angular.module("WebCoreModule").constant("Constants",{local:"local",wslBaseUrl:"https://www.wsl.ford.com/login.cgi?portstripping=no&back=",authorization:{any:"Any",all:"All"},version:"Ford Responsive Framework (FRF) 1.2.0"}),angular.module("WebCoreModule").constant("Prism",window.Prism),jQuery.fn.exists=function(){return 0!==this.length},jQuery.fn.outerHTML=function(){return jQuery("<div>").append(this.eq(0).clone()).html()},angular.merge=function(o){return angular.forEach(arguments,function(e){e!==o&&angular.forEach(e,function(e,n){o[n]&&o[n].constructor&&o[n].constructor===Object?angular.merge(o[n],e):o[n]=e})}),o};
...
angular.module("WcResponsiveTableModule").directive("wcRowSelectHeaderCheckbox",["$timeout",function(e){return{restrict:"E",template:'<input type="checkbox" class="wc-header-checkbox" name="{{responsiveTableController.id}}-header-checkbox" ng-click="rowSelectHeaderCheckboxController.selectAllRows()" ng-model="rowSelectHeaderCheckboxController.isChecked">',require:["wcRowSelectHeaderCheckbox","^wcResponsiveTable","^ngModel"],scope:{},bindToController:{wcRowSelectHeaderCheckbox:"@"},controllerAs:"rowSelectHeaderCheckboxController",controller:["$scope","$element",function(c,l){var o=l.parent().controller("wcResponsiveTable"),t=o.WcTableScopeService.getTableScope();this.checkIfAllChecked=function(){for(var e=o.table.find('tbody input[type="checkbox"]'),c=0;c<e.length;c++)if(!angular.element(e[c]).is(":checked")){this.isChecked=!1;break}},this.selectAllRows=function(){var e=this.isChecked?"table.select.checkbox.all":"table.select.checkbox.none";t.$broadcast(e)},t.$watch(function(){return o.ngModel},angular.bind(this,function(){this.checkIfAllChecked()})),t.$on("table.render.complete",angular.bind(this,function(){e(angular.bind(this,function(){this.isChecked=!0,this.checkIfAllChecked()}))}))}]}}]);
...
angular.module("WcResponsiveTableModule").directive("wcColumnSort",["$timeout",function(e){return{restrict:"A",require:["wcColumnSort","^wcResponsiveTable"],scope:{},bindToController:{wcColumnSort:"@",wcColumnSortDefault:"@",specialChars:"@",columnIndex:"@"},controllerAs:"columnSortController",controller:["$scope","$element",function(t,l){var o=l.parent().controller("wcResponsiveTable");this.tableScope=o.WcTableScopeService.getTableScope(),this.collectionLength=o.WcTableCollectionService.getCollectionLength(),this.resultsPerPage=o.WcTablePaginationService.getPaginationDefaults().resultsPerPage,this.sortReverse=!1,this.sortCollection=function(){o.WcTableCollectionService.sortEnabled=!0,e(angular.bind(this,function(){var e=o.WcTableCollectionService.getCollection();o.previousSortColumn=o.activeSortColumn,o.activeSortColumn=this.columnIndex,o.WcTableCollectionService.setCollection(function(e,t,l,o){return l=l?1:-1,o?e.sort(function(e,o){return 1===l?_.get(o,t).localeCompare(_.get(e,t)):_.get(e,t).localeCompare(_.get(o,t))}):e.sort(function(e,o){return _.get(e,t)<_.get(o,t)?1*l:_.get(e,t)>_.get(o,t)?-1*l:0})}(e,this.wcColumnSort,this.sortReverse,this.specialChars),o.WcTableCollectionService.sortEnabled,o.WcTableCollectionService.filterEnabled),this.tableScope.$broadcast("table.sort.complete",this.wcColumnSort,this.sortReverse),this.sortReverse=!this.sortReverse}),30)},this.wcColumnSortDefault&&("desc"==this.wcColumnSortDefault&&(this.sortReverse=!0),this.sortCollection())}],link:function(t,l,o,c){var s=c[0],n=c[1];l.addClass("wc-table-column-sort-heading"),n.WcTableScopeService.getTableScope().$on("table.sort.complete",function(e,t,o){var c=l.find("span[class~=glyphicon-sort]"),a=l.attr("class").match(/wc-table-column-\d+/)[0];t===s.wcColumnSort?(c.toggleClass("glyphicon-sort",!1),o?(c.toggleClass("glyphicon-sort-by-alphabet-alt",!0),c.toggleClass("glyphicon-sort-by-alphabet",!1)):(c.toggleClass("glyphicon-sort-by-alphabet",!0),c.toggleClass("glyphicon-sort-by-alphabet-alt",!1)),$("#"+n.id+" ."+a).addClass("wc-table-column-highlight")):(c.toggleClass("glyphicon-sort",!0),c.toggleClass("glyphicon-sort-by-alphabet glyphicon-sort-by-alphabet-alt",!1),$("#"+n.id+" ."+a).removeClass("wc-table-column-highlight"),s.sortReverse=!1)}),n.WcTableScopeService.getTableScope().$on("table.render.complete",function(e){var t=l.attr("class").match(/wc-table-column-\d+/)[0];l.hasClass("wc-table-column-highlight")?$("#"+n.id+" ."+t).addClass("wc-table-column-highlight"):$("#"+n.id+" ."+t).removeClass("wc-table-column-highlight")}),e(function(){var e=l.find(".header-text, .header-icons");$(e).on("click",function(){var e=s.collectionLength,t=!1;s.resultsPerPage<=25?e>=1e5&&(t=!0):s.resultsPerPage<=75?e>=1e4&&(t=!0):e>=1e3&&(t=!0),t&&s.tableScope.tableIsLoading(),s.sortCollection()})},0),l[0].children.length?e(function(){l.find(".header-text-wrapper").append('<span class="header-icons"><span class="glyphicon glyphicon-sort"></span></span>')},0):l.append('<span class="glyphicon glyphicon-sort"></span>')}}}]);
angular.module("WcResponsiveTableModule").directive("wcColumnFilter",["$compile","$timeout","$document","_","WcTranslateConfiguratorService","$translate",function(e,t,i,l,n,r){return{restrict:"A",require:["wcColumnFilter","^wcResponsiveTable"],scope:!0,bindToController:{wcColumnFilter:"@",wcColumnFilterDelay:"@"},controllerAs:"columnFilterController",controller:["$scope","$element",function(r,o){n.loadPartAndRefresh("WC-dataTable");var a=function(e){var t=i[0].createElement("div");return t.innerHTML=e,t.childNodes[0].nodeValue},c=o.parent().controller("wcResponsiveTable");this.tableScope=c.WcTableScopeService.getTableScope();var s=c.WcTableCollectionService.getCollection();this.collection=s,this.predicate=this.wcColumnFilter,this.wcColumnFilterDelay=this.wcColumnFilterDelay||0,this.isMultiSelect=!1,this.mathFilterOptions=[{id:"==",name:"="},{id:"<",name:a("&lt;")},{id:"<=",name:a("&le;")},{id:">",name:a("&gt;")},{id:">=",name:a("&ge;")},{id:"!=",name:a("&ne;")}],this.tableScope.$on("table.collection.update",angular.bind(this,function(){s=c.WcTableCollectionService.getCollection(),t(angular.bind(this,function(){this.filterColumn()}),0)})),this.filterColumn=function(){var e=c.element.find(".active-filters");c.WcTableCollectionService.filterEnabled=!0;var t=c.WcTableCollectionService.filterEnabled,i=c.WcTableCollectionService.sortEnabled,n=c.WcColumnFilterService.getColumnsToFilter();if(0===n.length)e.toggleClass("hidden",!0),c.WcTableCollectionService.filterEnabled=!1,c.WcTableCollectionService.setCollection(s,i,t);else{e.toggleClass("hidden",!1);var o=l.filter(s,angular.bind(this,function(e){for(var t=!1,i=0;i<n.length;i++){if(!l.get(e,n[i].predicate))return!1;if(angular.isArray(n[i].value))for(var o=0;o<n[i].value.length;o++){if(!(l.get(e,n[i].predicate).toString().toLowerCase().indexOf(n[i].value[o].toLowerCase())>-1))return!1;t=!0}else if(n[i].isMathFilter){var a=c.selectedMathFilterOption[n[i].predicate].id,s=n[i].value,p=Number(s),d=Number(l.get(e,n[i].predicate));if(!r.$eval(d+a+p))return!1;t=!0}else{if(!("default"!==l.get(e,n[i].predicate,"default")&&l.get(e,n[i].predicate).toString().toLowerCase().indexOf(n[i].value.toLowerCase())>-1))return!1;t=!0}}return t}));c.WcTableCollectionService.setCollection(o,i,t)}},this.dismissFilter=function(e){$('input[wc-column-filter="'+e+'"], select[wc-column-filter="'+e+'"]').val(""),c.WcColumnFilterService.removeColumnToFilter(e),this.filterColumn(),$(".active-filters ."+e.replace(".","-")).remove(),o.parents("th").find("span.glyphicon-filter").remove()},this.filterListener=function(){var i,n=this.predicate.replace(".","-"),a=o.val();if(l.find(c.WcColumnFilterService.getColumnsToFilter(),{predicate:this.predicate})&&(i=l.find(c.WcColumnFilterService.getColumnsToFilter(),{predicate:this.predicate}).value),!(void 0===a||""===a&&""===i||""===a&&void 0===i||a===i&&""!==o.attr("wc-math-filter"))){c.WcColumnFilterService.setColumnsToFilter(this.predicate,a,""===o.attr("wc-math-filter")),this.filterColumn();var s=o.parents("th").find("span.glyphicon-filter");n=this.predicate.replace(".","-");var p=c.element.find(".active-filters ."+n);if(""!==a){var d=o.parents("th").find(".header-text").text();s.length||(o.parents("th").find(".header-icons").length>0&&!s.length?o.parents("th").find(".header-icons").append('<span class="glyphicon glyphicon-filter"></span>'):t(function(){o.parents("th").find(".header-text-wrapper").append('<span class="header-icons"><span class="glyphicon glyphicon-filter"></span></span>')},0)),p.length||c.element.find(".active-filters").append(e('<button class="btn btn-active-filter '+n+'" ng-click="columnFilterController.dismissFilter(\''+this.predicate+"')\"><span>"+d+'</span>&nbsp;&nbsp;<span class="glyphicon glyphicon-remove"></span></button>')(r))}else if(""===a){s.remove();var u=p.parent();p.remove(),u.children().length||c.element.find(".active-filters").toggleClass("hidden",!0)}}r.$broadcast("table.filter.complete")}}],link:function(t,i,n,o){var a=o[0],c=o[1];if(""===i.attr("wc-math-filter")&&(c.selectedMathFilterOption[a.predicate]=a.mathFilterOptions[0],i.wrap('<div class="row wc-math-filter-row"><div class="col-xs-8"></div></div>'),i.parent().before(e('<div class="col-xs-4 math-dropdown"><select class="form-control input-sm" ng-change="columnFilterController.filterListener()" ng-options="option.name for option in columnFilterController.mathFilterOptions track by option.id" ng-model="columnFilterController.tableScope.responsiveTableController.selectedMathFilterOption[columnFilterController.predicate]" id="wc-math-filter-'+a.predicate.replace(".","-")+'"></select></div>')(t))),"SELECT"!==i.prop("tagName")||i.attr("wc-math-filter"))i.keyup(l.debounce(a.filterListener.bind(a),a.wcColumnFilterDelay));else{a.isMultiSelect=i.attr("multiple");var s=l.uniq(l.map(a.collection,a.predicate)).sort(),p=$("<option></option>");a.isMultiSelect||(p.attr("value",""),p.text(r.instant("columnFilter.mathFilter.selectDefaultText")),i.append(p)),l.each(s,function(e){var t=$("<option></option>");t.attr("value",e),t.text(e),i.append(t)}),i.on("change",a.filterListener.bind(a))}i.on("click",function(e){e.stopPropagation()})}}}]);
angular.module("WebCoreModule").directive("wcExportToExcel",["$window","XLSX","saveAs","_","WcTranslateConfiguratorService",function(e,t,r,n,o){return{restrict:"E",template:'<button class="btn icon icon-excel" ng-click="exportToXslxController.makeExcel()" aria-label="{{"exportTo.excelButtonAriaLabel" | translate}}"> <i class="fa fa-file-excel-o"  aria-hidden="true" title="{{"exportTo.excelButtonTitle" | translate}}"></i><span class="hidden-xs">{{"exportTo.excelButtonText" | translate}}</span></button>',replace:!0,require:["wcExportToExcel"],scope:{},controllerAs:"exportToXslxController",controller:["$scope","$element",function(a,l){o.loadPartAndRefresh("WC-dataTable");var s=l.parent().controller("wcResponsiveTable");s=s||a.responsiveTableController||a.$parent.responsiveTableController,this.exportToExcel=function(o,a,l){var i=s.WcTableCollectionService.getCollection(),c=i.length,u=[];u.push(o);for(var h=u[0].length,p=0;p<c;++p){for(var f=[],v=0;v<h;v++){var x=n.get(i[p],a[v]);f.push(x)}u.push(f)}for(var d=(l=l.toString())+".xlsx",g={SheetNames:[],Sheets:{}},b=this.sheetFromArrayOfArrays(u),T=[],v=0;v<a.length;++v){var m={},A=0;A=Math.max.apply(Math,u.map(function(e){return null==e[v]?0:e[v].toString().length})),m.wch=A,T.push(m)}b["!cols"]=T;var y=[];b["!merges"]=y,g.SheetNames.push(l),g.Sheets[l]=b;var w=t.write(g,{type:"binary"});r(new e.Blob([this.s2ab(w)],{type:"application/octet-stream"}),d)},this.s2ab=function(e){if("undefined"!=typeof ArrayBuffer){for(var t=new ArrayBuffer(e.length),r=new Uint8Array(t),n=0;n!=e.length;++n)r[n]=255&e.charCodeAt(n);return t}for(var t=new Array(e.length),n=0;n!=e.length;++n)t[n]=255&e.charCodeAt(n);return t},this.sheetFromArrayOfArrays=function(e){for(var r={},n={s:{c:1e7,r:1e7},e:{c:0,r:0}},o=0;o!=e.length;++o)for(var a=0;a!=e[o].length;++a){n.s.r>o&&(n.s.r=o),n.s.c>a&&(n.s.c=a),n.e.r<o&&(n.e.r=o),n.e.c<a&&(n.e.c=a);var l={v:e[o][a]};if(null!=l.v){var s=t.utils.encode_cell({c:a,r:o});"number"==typeof l.v?l.t="n":"boolean"==typeof l.v?l.t="b":l.v instanceof Date?(l.t="n",l.z=t.SSF._table[14],l.v=this.dateNum(l.v)):l.t="s",r[s]=l,0===o&&(r[s].bold=!0)}}return n.s.c<1e7&&(r["!ref"]=t.utils.encode_range(n)),r},this.dateNum=function(e,t){var r=e.getTime();return t&&(r+=1263168e5),(r+22091616e5)/864e5},this.makeExcel=function(){for(var e=l.parent().attr("id"),t=l.parent().find("th"),r=[],n=0;n<t.length;n++)"Actions"!==t[n].innerText&&""!==t[n].innerText.trim()&&r.push(t[n].childNodes[0].wholeText);for(var o=l.parent().find("tr")[1].children,a=[],s=0;s<t.length;s++)if(o[s].getAttribute("ng-bind")){var i=o[s].getAttribute("ng-bind");a.push(i.substr(i.indexOf(".")+1))}else t[s].getAttribute("wc-column-sort")&&a.push(t[s].getAttribute("wc-column-sort"));this.exportToExcel(r,a,e)}}]}}]);
angular.module("WebCoreModule").directive("wcExportToPdf",["pdfMake","WcTranslateConfiguratorService",function(e,t){return{restrict:"E",template:'<button class="btn icon icon-pdf" ng-click="exportToPdfController.makePDF()" aria-label="{{"exportTo.pdfButtonAriaLabel" | translate}}"><i class="fa fa-file-pdf-o" aria-hidden="true" title="{{"exportTo.pdfButtonTitle" | translate}}"></i><span class="hidden-xs">{{"exportTo.pdfButtonText" | translate}}</span></button>',replace:!0,require:["wcExportToPdf"],scope:{},controllerAs:"exportToPdfController",controller:["$scope","$element",function(r,o){t.loadPartAndRefresh("WC-dataTable");var n=o.parent().controller("wcResponsiveTable");n=n||r.responsiveTableController||r.$parent.responsiveTableController,this.exportToPDF=function(t,r,o){for(var l=n.WcTableCollectionService.getCollection(),a=l.length,i=t.length,c=[],s=[],d="",p=0;p<i;p++)t[p]={text:t[p],bold:!0};c.push(t);for(var f=[],u=0;u<i;u++)f.push("auto");if(a>0)for(p=0;p<a;p++){for(var h=l[p],b=0;b<i;b++){var T=r[b].toString();if(-1==T.indexOf("."))d=h[r[b]];else{for(var g=T.split("."),v=h,x=0;x<g.length;x++)v=v[g[x]];d=v}s.push(d)}c.push(s),s=[]}var C={content:[{table:{headerRows:1,widths:f,body:c}}]};return o=o.toString()+".pdf",e.createPdf(C).download(o)},this.makePDF=function(){for(var e=o.parent().attr("id"),t=o.parent().children("table").children("thead").children("tr").children("th"),r=[],l=0;l<t.length;l++)"Actions"!==t[l].innerText&&""!==t[l].innerText.trim()&&r.push(t[l].childNodes[0].wholeText);var a=[];if(n.WcTableCollectionService.getCollection().length>0)for(var i=o.parent().children("table").children("tbody").children("tr")[0].getElementsByTagName("td"),c=0;c<i.length;c++)if(i[c].getAttribute("ng-bind")){var s=i[c].getAttribute("ng-bind"),d=s.substr(s.indexOf(".")+1);a.push(d)}else t[c].getAttribute("wc-column-sort")&&a.push(t[c].getAttribute("wc-column-sort"));this.exportToPDF(r,a,e)}}]}}]);
...
//# sourceMappingURL=FRF-webCore.v1.2.0.min.js.map